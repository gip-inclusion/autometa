...
def test_the_sources_entry_is_marked_active_on_the_knowledge_pages(client):
    """Les connaissances vivent sous Sources : c'est cette entrée qui porte l'état actif."""
    html = client.get("/knowledge", headers=_h()).text

    index = html.index('href="/sources"')
