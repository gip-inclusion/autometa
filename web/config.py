...
PUBLIC_S3_BUCKET_STAGING = os.getenv("PUBLIC_DASHBOARDS_BUCKET_STAGING")
PUBLIC_S3_BUCKET_PROD = os.getenv("PUBLIC_DASHBOARDS_BUCKET_PROD")
PUBLIC_DASHBOARDS_STAGING_URL = os.getenv(
    "PUBLIC_DASHBOARDS_URL_STAGING", "https://staging.statistiques.inclusion.gouv.fr"
)
...
DATA_INCLUSION_SSH_HOST = os.getenv("DATA_INCLUSION_SSH_HOST", "")
DATA_INCLUSION_SSH_USER = os.getenv("DATA_INCLUSION_SSH_USER", "")
