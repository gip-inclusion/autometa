...
def cleanup(dry_run: bool = False) -> dict:
    ...
    try:
        ...
        protected_prefixes = ("matometa-", "coolify")
        stopped = []
    ...
    try:
        ...
        # Protect named volumes (gitea_data, coolify_*)
        protected_volumes = {"gitea_data"}
        unused = [v for v in unused if v not in protected_volumes and not v.startswith("coolify_")]
