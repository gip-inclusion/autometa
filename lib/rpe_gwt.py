...
def render_gwt(template: str, *, strong_name: str, policy_login: str, policy_dash: str, public_pass: str) -> str:
    """Substitue les signatures GWT (strong-name, tokens de service, mot de passe public) dans un template."""
    return (
        template
        .replace("__STRONG_NAME__", strong_name)
        .replace("__POLICY_LOGIN__", policy_login)
        .replace("__POLICY_DASH__", policy_dash)
