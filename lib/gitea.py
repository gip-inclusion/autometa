...
class GiteaClient:
    ...
    def get_repo(self, owner: str, repo: str) -> dict:
        ...
        resp = self._client.get(self._url(f"/repos/{owner}/{repo}"))
        resp.raise_for_status()
        return resp.json()
    ...
    def delete_repo(self, owner: str, repo: str) -> None:
        """Delete a repository."""
        resp = self._client.delete(self._url(f"/repos/{owner}/{repo}"))
        resp.raise_for_status()
    ...
    def list_webhooks(self, owner: str, repo: str) -> list[dict]:
        ...
        resp = self._client.get(self._url(f"/repos/{owner}/{repo}/hooks"))
        resp.raise_for_status()
        data = resp.json()
    ...
    def version(self) -> str:
        ...
        resp = self._client.get(self._url("/version"))
        resp.raise_for_status()
