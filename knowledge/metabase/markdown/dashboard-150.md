...
💾 Source des données : le service des emplois de l'inclusion
...
Chiffres clés sur les fiches de poste en tension

☞  Votre tableau de bord est composé de 3 onglets thématiques

☞  Comment les données de votre tableau de bord peuvent-elles vous être utiles ?

Une fiche de poste est considérée en tension si elle remplit les 4 conditions suivantes :
...
l’employeur n'a pas refusé des candidatures dans les 30 derniers jours pour le motif “Pas de poste ouve
