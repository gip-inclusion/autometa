# Dashboard : DDETS/DREETS- Suivi du contrôle a posteriori

### a. Choix du ratio par département lors de l'échantillonnage
Ce tableau indique par défaut le ratio moyen de structures sélectionnées toutes campagnes confondues. Pour avoir le ratio précis sur une campagne, vous pouvez filtrer sur la campagne voulue. 

# 3. Quels sont les résultats du contrôle a posteriori sur mon territoire ? 

### b. Structures sélectionnées pour le contrôle a posteriori

# soit ➡️

# 1. Quel est le périmètre prévu du contrôle a posteriori sur mon territoire ?


# 2. Quel est l'état d'avancement de la campagne de contrôle a posteriori en cours sur mon territoire ? 
...
### Objectifs
💻  Réalisé par : Le pilotage de l'inclusion

#### ✅ Comment ce tableau de bord vous accompagne dans vos missions ?
> "Je veux suivre l'avancée de la campagne de contrôle a postériori pour ma DDETS ou de mes DDETS"

> "Je veux identifier les sujets qui posent le plus de difficultés pour entreprendre des actions"

 #### ✅ A quelles questions ce tableau de 
...
JOIN "public"."cap_campagnes" AS "Cap Campagnes - ID Cap Campagne" ON "public"."cap_structures"."id_cap_campagne" = "Cap Campagnes - ID Cap Campagne"."id" LEFT 
JOIN "public"."suivi_cap_structures" AS "Suivi Cap Structures - ID Structure" ON "public"."cap_structures"."id_structure" = "Suivi Cap Structures - ID Structure"."id_structure"
```
...
FROM "public"."cap_structures" LEFT 
JOIN "public"."cap_campagnes" AS "Cap Campagnes" ON "public"."cap_structures"."id_cap_campagne" = "Cap Campagnes"."id"
```
