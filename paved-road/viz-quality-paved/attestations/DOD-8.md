...
**Critère** — [du brief : « requêtes de ressources en échec »] Le script de mesure d'audience du gabarit n'est jamais chargé pendant la vérification : elle ne compte aucune fausse visite, et l'absence de ce script n'est pas un problème.
...
tests/test_dashboard_quality.py .                                        [ 50%]
browser/test_verify_dashboard.py .                                       [100%]

======================= 2 passed, 39 deselected in 2.76s =======================
```
