...
**Critère** — [du brief : « mise en page cassée »] Quand la page affiche son bloc d'erreur avec un texte, ou montre encore « Chargement… » une fois la page chargée, le verdict est « échoué » et le problème cite ce texte.
...
======================= 2 passed, 39 deselected in 1.32s =======================
```
