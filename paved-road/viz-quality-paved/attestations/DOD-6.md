...
**Critère** — [du brief : « mise en page cassée »] Quand le contenu déborde horizontalement sur un écran d'ordinateur de 1280 pixels de large, ou quand la page n'affiche aucun texte, le verdict est « échoué ».
...
======================= 2 passed, 39 deselected in 1.44s =======================
```
