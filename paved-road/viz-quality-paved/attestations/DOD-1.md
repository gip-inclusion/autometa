...
**Critère** — [du brief : « rendu headless », « verdict structuré réussi / échoué »] Quand l'agent lance la vérification sur un tableau de bord sain, la page est affichée dans un navigateur sans écran et le verdict est « réussi », avec une liste de problèmes vide — sans qu'Autometa ait besoin d'être démarré.
...
======================= 4 passed, 37 deselected in 3.66s =======================
```
