...
**Critère** — [du brief : « tableau de bord généré »] Quand le tableau de bord n'a pas de page d'accueil, le verdict est « échoué » avec le problème « index.html introuvable », sans que l'outil plante.
...
======================= 2 passed, 39 deselected in 1.36s =======================
```
